...
class Plant{
    ...
    public function show(){
        ...
        echo '<a href="#"><img src="../img/icons/line-chart.png" alt="line-chart"></a>';
        echo '<a href="#"><img src="../img/icons/bar-chart.png" alt="bar-chart"></a>';
        echo '</div>';
        echo '</div>';
        echo '<div class="plant-details">';
        echo '<img src="../img/' . $this->name .'.jpg">';
        echo '<p>Last updated: ' . $this->getUpdate($this->id) .'</p>';
        echo '<p class="normal">Water level: ' . $this->getHumidityValue($this->id) . '%</p>';
